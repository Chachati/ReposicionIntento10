...
public class ProjectTest {
    ...
    private void setupBadFormedProject1() {
        ...
        Group group = new Group(faker.team().name());
        badFormedProject1 = new Project(LocalDate.now().minusDays(10), LocalDate.now().plusDays(10), group);
    }

    private void setupBadFormedProject2() {

        Group group = new Group(faker.team().name());
        badFormedProject2 = new Project(LocalDate.now().minusDays(10), LocalDate.now().plusDays(10), group);
    ...
    private void setupBadFormedProject3() {
        ...
        Group group = new Group(faker.team().name());
        badFormedProject3 = new Project(LocalDate.now().minusDays(10), LocalDate.now().plusDays(10), group);
        ...
        new NormalActivity(Activity.ACTIVE_STATE, iteration);
    }

    private void setupBadFormedProject4() {

        Group group = new Group(faker.team().name());
        badFormedProject4 = new Project(LocalDate.now().minusDays(10), LocalDate.now().plusDays(10), group);
        ...
        NormalActivity activity2 = new NormalActivity(Activity.ACTIVE_STATE, null);
        activity2.addStep(new Step(faker.team().name(), Duration.ofDays(1)));
        new DocumentedActivity(Activity.ACTIVE_STATE, iteration, activity2);
    }

    private void setupBadFormedProject5() {

        Group group = new Group(faker.team().name());
        badFormedProject5 = new Project(LocalDate.now().minusDays(10), LocalDate.now().plusDays(10), group);
        ...
        DocumentedActivity documentedActivity2 = new DocumentedActivity(Activity.ACTIVE_STATE, iteration, null);
    ...
    private void setupBadFormedProject6() {
        ...
        Group group = new Group(faker.team().name());
        badFormedProject6 = new Project(LocalDate.now().minusDays(10), LocalDate.now().plusDays(10), group);
        ...
        NormalActivity activity2 = new NormalActivity(Activity.ACTIVE_STATE, null);
        DocumentedActivity documentedActivity2 = new DocumentedActivity(Activity.ACTIVE_STATE, iteration, activity2);
        documentedActivity2.addQuestion(new Question(Question.EASY_QUESTION, faker.team().name(), Duration.ofDays(1)));
    }
}
